...
#include "Arial_black_16.h"//Arial_Black_16_ISO_8859_1//Arial14
//#include "Arial14.h"
...
byte index1 = 0;            // defines the position into your array
int i;            
char greeting[] = "E-notice board using IOT";
/*--------------------------------------------------------------------------------------
   ...
   {       
    ...
    while(Serial.available() > 0){
       ...
       {         
           ...
           message[index1] = r_char;     // Stores the character in message array
